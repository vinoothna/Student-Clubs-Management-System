# Generated by Django 2.1.2 on 2018-10-25 13:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='club',
            fields=[
                ('club_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='club_admin',
            fields=[
                ('club_admin_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('reg_member_id', models.AutoField(default=1, primary_key=True, serialize=False)),
                ('date_of_joining', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('club_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CREW.club')),
            ],
        ),
        migrations.CreateModel(
            name='comment',
            fields=[
                ('comment_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='likes',
            fields=[
                ('like_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='media',
            fields=[
                ('media_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='notification',
            fields=[
                ('notification_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='poll',
            fields=[
                ('poll_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('poll_participation_id', models.AutoField(default=1, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='post',
            fields=[
                ('post_id', models.AutoField(default=1, primary_key=True, serialize=False)),
                ('content', models.TextField()),
        ...
        migrations.CreateModel(
            name='rooms',
            fields=[
                ('room_id', models.AutoField(default=1, primary_key=True, serialize=False)),
